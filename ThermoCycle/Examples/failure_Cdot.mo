...
model failure_Cdot
  ...
  ThermoCycle.Source_Cdot2 Heat_source1(
    cp=4232,
    Mdot_0=0.15,
    T_0=473.15)
    annotation (Placement(transformation(extent={{68,28},{84,44}})));
  ThermoCycle.Components.FlowConst flowConst(
    A=1,
    V=1e-3,
    Mdotnom=2,
    Discretization=ThermoCycle.Enumerations.Discretizations.centr_diff,
    N=2,
    Tstart_inlet=473.15,
  ...
  ThermoCycle.Source_Cdot2 source_Cdot3_1
