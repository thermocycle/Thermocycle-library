...
package ThermoCycle "A library for the simulation of thermal systems"
  ...
  annotation (uses(                        CoolProp2Modelica,
    Modelica(version="3.2.1")),                             Documentation(info="<HTML>
...
<li><strong><a href=\"modelica://ThermoCycle.Media\">Media</a> </strong>contains a list of some of the fluid available in the library. The fluids in this package are labeled with the acronym <b>TC</b>.  The CoolProp2Modelica library is anyway necessary to allow the coupling with CoolProp for computing the thermo-physical and transport properties of the fluids.
