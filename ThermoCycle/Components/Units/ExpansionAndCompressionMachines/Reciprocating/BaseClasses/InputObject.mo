...
record InputObject "A base object for the mechanical design"
  ...
  parameter Modelica.SIunits.Length height "Height of object"
    annotation (Dialog(group="Geometry",enable = true));
  parameter Modelica.SIunits.Length width "Width of object"
    annotation (Dialog(group="Geometry",enable = (kind==1)));
  parameter Modelica.SIunits.Length radius "Radius of object"
