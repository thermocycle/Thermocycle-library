...
package HeatStorageWaterHeater "Water Tank with an internal heat exchanger"
  ...
  ThermoCycle.Interfaces.HeatTransfer.ThermalPortL Wall_ext
    ...
    ThermoCycle.Interfaces.Fluid.FlangeB MainFluid_ex(redeclare package Medium
        = SecondaryFluid) annotation (Placement(transformation(extent={{-14,72},{6,
              92}}),
  ...
  model Cell1DimInc_2ports
    "1-D incompressible fluid flow model with two thermal ports"
    ...
    ThermoCycle.Interfaces.HeatTransfer.ThermalPortL HXInt annotation (
        Placement(transformation(extent={{-14,-60},{6,-40}}),
          iconTransformation(extent={{-14,-60},{6,-40}})));
  ...
  equation
    ...
    /* ENERGY BALANCE */
    Vi*rho*der(h) + M_dot*(hnode_ex - hnode_su) - A_hx*qdot_hx = Ai*qdot
      "Energy balance";
