...
ParametrizedModels.Tank             tank_pL(
  ...
  ThermoCycle.Components.HeatFlow.Sensors.SensTp sensorEvaExp(redeclare package
      Medium =         Medium)
    annotation (Placement(transformation(extent={{2,56},{16,70}})));
  ...
  ORCNext.Validation.SES36._2802_DownUp_5Hz.Sources.f_pp_spline f_pump1
                             annotation (Placement(transformation(
          extent={{-166,-48},{-146,-28}})));
equation

 m_dot_wf = orcMassFlow_10_1.M_dot_orc;
 ...
 p_exp_out = expander.OutFlow.p;
  ...
  connect(sensorEvaExp.OutFlow, pdropHP_143_1.InFlow) annotation (Line(
      points={{13.9,59.64},{22,59.64},{22,50},{29,50}},
      color={0,0,255},
      smooth=Smooth.None));
  ...
  connect(evaGw.OutFlowPF, sensorEvaExp.InFlow) annotation (Line(
      points={{-10.5,58.4},{-2.25,58.4},{-2.25,59.64},{4.1,59.64}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(f_pump1.y, pump_AD.flow_in) annotation (Line(
      points={{-145,-38},{-113.8,-38},{-113.8,-51}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(firstOrder.y, pump_AD.M_dot_ext) annotation (Line(
      points={{-121,-6},{-116,-6},{-116,-8},{-107.95,-8},{-107.95,-50.25}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(orcMassFlow_10_1.M_dot_orc, firstOrder.u) annotation (Line(
      points={{-164,26.2},{-154,26.2},{-154,24},{-152,24},{-152,0},{-160,0},{-160,
          -6},{-144,-6}},
      color={0,0,127},
      smooth=Smooth.None));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-180,
            -160},{140,120}}), graphics), Icon(coordinateSystem(extent={{-180,-160},
            {140,120}})),
