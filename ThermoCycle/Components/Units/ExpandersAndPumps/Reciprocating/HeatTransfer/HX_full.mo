...
model HX_full "A combination of Cylinder model and a reciprocating machine"
  ...
  Cylinder irimescu(
    ...
    stroke=recipFlange.stroke,
    redeclare model HeatTransfer =
        ThermoCycle.Components.Units.ExpandersAndPumps.Reciprocating.HeatTransfer.Irimescu2013)
  ...
  Cylinder gnielinski(
    ...
    stroke=recipFlange.stroke,
    redeclare model HeatTransfer =
        ThermoCycle.Components.Units.ExpandersAndPumps.Reciprocating.HeatTransfer.Gnielinski2010)
