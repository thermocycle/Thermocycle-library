...
Eta_tot =sum(Eta_tot_N)/N;
    ...
    <p><big>Model <b>AbsSoltigua</b> solves the 1D radial energy balance around the Heat Collector Element of the Soltigua PTMx parabolic trough solar collector based on the Soltigua data sheet
